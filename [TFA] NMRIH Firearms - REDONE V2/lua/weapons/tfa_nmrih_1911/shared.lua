...
SWEP.ViewModel			= "models/weapons/tfa_nmrih/v_fa_1911.mdl" --Viewmodel path
SWEP.ViewModelFOV = 50

SWEP.WorldModel			= "models/weapons/tfa_nmrih/w_fa_1911.mdl" --Viewmodel path
...
SWEP.Primary.Sound = "Weapon_1911.Single"
...
SWEP.IronSightsPos = Vector(-2.53, 0, 1.08)
SWEP.IronSightsAng = Vector(0.419, 0.025, 0)
