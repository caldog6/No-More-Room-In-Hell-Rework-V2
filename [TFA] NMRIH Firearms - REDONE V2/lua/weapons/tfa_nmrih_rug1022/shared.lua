...
SWEP.ViewModel			= "models/weapons/tfa_nmrih/v_fa_ruger1022.mdl" --Viewmodel path
SWEP.ViewModelFOV = 50

SWEP.WorldModel			= "models/weapons/tfa_nmrih/w_fa_ruger1022.mdl" --Viewmodel path
SWEP.HoldType = "ar2"
...
SWEP.Primary.SpreadRecovery = 5.5 --How much the spread recovers, per second.
